function [xr,iter] = fzerosimp(f,xl,xu)
% A Function for Brent?s root-finding algorithm based on a MATLAB M-file 
% developed by Cleve Moler(2005).

a = xl; b = xu; fa = f(a); fb = f(b);
c = a; fc = fa; d = b - c; e = d; iter=0;
while (1)
    iter=iter+1;
    if fb == 0, break, end
